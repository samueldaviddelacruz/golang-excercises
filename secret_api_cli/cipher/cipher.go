...
// EncryptWriter will return a writer that will write encripted data to
// the original writer
...
// DecryptReader will return a reader that will read encrypted data from
// the provided reader and give the user a way to read that data as it if was
// not encrypted
