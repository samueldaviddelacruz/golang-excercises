...
func main() {
	lineItems := []LineItem{
		...
		{
			UnitName:       "Line item with a very long description here o test that word wrapping is implemented and working as intended",
			PricePerUnit:   1455, // in cents
			UnitsPurchased: 3,
		},
		{
	...
	//Banner -- Logo
	pdf.ImageOptions("images/dr_flag.png", 225.0, 0+(bannerHt-bannerHt/1.5)/2.0, 0, bannerHt/1.5, false, gofpdf.ImageOptions{
		ReadDpi: true,
	}, 0, "")
	...
	pdf.MultiCell(124.0, lineHt*1.5, "(123) 456-7890\nalphaelena@gmail.com\nsamueldaviddelacruz.github.io", gofpdf.BorderNone, gofpdf.AlignRight, false)
	...
	summaryBlock(pdf, xIndent*2.0+lineHt*12.5, bannerHt+lineHt*2.0, "Invoice Number", "0000000134")
